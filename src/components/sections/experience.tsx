    ...
    <section className="mt-10 max-w-2xl mx-auto w-full">
      ...
      <div className="my-3 flex flex-col gap-y-8">
        {/* <div className="flex flex-col gap-y-6">
          <div className="flex flex-row items-start justify-between">
            <div className="flex flex-row items-center justify-start gap-x-2">
              <div className="p-1 w-14 h-14 border rounded-[8px] bg-neutral-50" />
              <div className="flex flex-col">
                <div className="flex flex-row items-center justify-start gap-x-2">
                  <h1 className="text-lg text-neutral-700 font-semibold dark:text-neutral-200">
          ...
          <div className="">
            ...
            <ul className="list-disc px-4 text-neutral-400 leading-6 text-base font-medium mt-3">
              <li>
                Owned the end-to-end frontend architecture for a high-frequency
                crypto trading platform, building the system from scratch with a
                strong focus on performance and scalability enabling
                multi-exchange real-time trading.
              </li>
              <li>
                Led frontend development efforts across the full product
                lifecycle, collaborating closely with product managers and
                backend engineers while executing Agile/Scrum workflows.
              </li>
              <li>
                Developed and shipped a production-grade React Native
                application to the Apple App Store and Google Play Store,
                supporting 1M+ global doctors with optimized rendering,
                efficient data fetching, and a reliable location-based discovery
                experience.
              </li>
              <li>
                Contributed to an open-source microservices platform, building
                and maintaining features in a distributed system.
              </li>
              <li>
                Mentored interns, conducting code reviews, improving training
                plans with the current frontend technologies and patterns.
              </li>
            </ul>
          </div>
        </div>
