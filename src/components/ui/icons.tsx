"use client";
import { motion, SVGMotionProps, type Variants } from "motion/react";
...
export const Learn = () => {
  return (
    ...
    >
      <motion.g
        id="kvg:StrokePaths_05b66"
        className="fill-none stroke-black dark:stroke-white stroke-[6] stroke-linecap-round stroke-linejoin-round"
      >
        <motion.g id="kvg:05b66">
          <motion.g id="kvg:05b66-g1">
            <motion.g id="kvg:05b66-g2">
              <motion.path
                id="kvg:05b66-s1"
...
export const LeetCode = () => {
  return (
    <a
      href="https://leetcode.com/u/vilas_chauvhan"
      target="_blank"
      rel="noopener"
    >
      <motion.svg
